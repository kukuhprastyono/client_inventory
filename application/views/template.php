...
<body>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <!-- User Profile-->
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" aria-expanded="false" onclick="loadMenu('<?= base_url('barang') ?>')"><i class="mdi mdi-border-all"></i><span class="hide-menu">Barang</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" aria-expanded="false" onclick="loadMenu('<?= base_url('departemen') ?>')"><i class="mdi mdi-border-all"></i><span class="hide-menu">Departemen</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" aria-expanded="false" onclick="loadMenu('<?= base_url('pengadaan') ?>')"><i class="mdi mdi-border-all"></i><span class="hide-menu">Pengadaan</span></a></li>
    ...
    <!--chartis chart-->
    <script src="<?= base_url('assets/xtreme_admin_lite') ?>/assets/libs/chartist/dist/chartist.min.js"></script>
    <script src="<?= base_url('assets/xtreme_admin_lite') ?>/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>
    <script src="<?= base_url('assets/xtreme_admin_lite') ?>/dist/js/pages/dashboards/dashboard1.js"></script>
